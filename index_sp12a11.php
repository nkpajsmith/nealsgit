                ...
                <div id="bd" class="bd-home"><div id="bd-inner">
                        ...
                        <div class="intro clearfix">
                            ...
                            <div class="intro-main">
                                  <h1>Attract Business with Techmatcher Profiles!</h1> 
                                   <p><b>Find new customers.</b> Using in-depth profiles, we match your service offerings with users' specific needs. Techmatcher's business tools then help you manage your clients by providing rich business analysis keying you to the needs of the market. With new insight and efficiency, your firm can grow by doing what you do well.</p>
                            </div><!-- /intro-main -->
