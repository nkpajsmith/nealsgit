...
<html><head><title>Subscription Page</title><?php include '../../scripts1.php';?></head>
    <body>
        <?php
        include '../../includes/header_consumer.php';
        //include '../../header.php';
...
<tr>
      ...
      <td><b><?php 
      if(!empty($_SESSION['consumer'])){ ?> <?php echo $_SESSION['consumer']['itconsumername']; ?><?php } ?></b></td>
            </tr>
            ...
            <tr>
              ...
              <td><b><?php if(!empty($_SESSION['consumer'])){ ?><?php echo $_SESSION['consumer']['itconsumer_emailaddress']; ?><?php } ?></b></td>
            </tr>
        </table>
        </div>
<div class="flt w100">
<div class="flt mlt15" >
            ...
            <form name="form1" method="post" action="consumer_submit.php">
...
?>
                ...
                <table>
                    <tr>
                        <td align="right">Package Type <?php $consumerId = $_SESSION['consumer']['itconsumer_id'];
                                 ?></td>
                        ...
                        <td><select name = "address_types" onchange='change_value(this)'>
                                ...
                                $addressez = getsubscriptionforconsumer($consumerId);
