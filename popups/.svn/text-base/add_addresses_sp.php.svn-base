...
<div class="modal-wrap">
    <div id="modal_add_address_sp" class="modalwindow"><div class="modalwindow-bkg">
            <!-- modal form -->
            <div class="modal-form">
                <form name="address" id="adding_address" method="post" onsubmit="return add_provider_address($(this));">
                    <table width="90%" border="0" cellspacing="2" cellpadding="5" align="center">
                        <tr>
                            ...
                            <td width="69%"><select style="width:155px" name = "address_types" >
                                    <option></option>
                                    <?php
                    ...
                    <div id="div_register_errors_sp1" style="margin:10px; color: red;"></div>
                </form>
            </div>
