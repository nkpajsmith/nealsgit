...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <meta name="google-site-verification" content="4bvBGCMYeKKGGaEaVrrAnq2BaqdCpXmREE1zi1FJYVc" />
        <!-- title -->
                ...
                <div id="bd" class="bd-home"><div id="bd-inner">
                        ...
                        <div class="intro clearfix">
                            ...
                            <div class="intro-main">
                                <h1>What is Techmatcher?</h1> 
                                <p><b>Techmatcher</b> is a new online service that connects both businesses and individual who need technical services with highly qualified technology service providers -<em><strong> right in their local area</strong></em>. </p>
                                <p> Using plain language (not technical terms) and through in-depth profiles, we match users' specific needs to providers equipped to meet those needs. Match results display unbiased independent <b>quality ratings</b> of the service providers leading to simple efficient decisions.</p>
                            </div> <!-- /intro-main -->
                            ...
                            <div class="intro-side">
                                ...
                                <div class="intro-side-content">
                                    <div class="home-start-buttons">
                                    	<a href="#" onclick="return open_signup_dialog(2)">Sign Up Now &raquo;</a>
                                    	<a href="techuser_tour.php">Take the Tour &raquo;</a>
                                </div>
                                    ...
                                    <div class="account-login clearfix">
                                        ...
                                        <span class="action-btn"><a href="#" onclick="open_login_consumer_dialog();"><span>Login</span></a></span>
