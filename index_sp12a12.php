                ...
                <div id="bd" class="bd-home"><div id="bd-inner">
                        ...
                        <div class="intro clearfix">
                            ...
                            <div class="intro-main">
                                <h1>Stand Out, Be Found on Techmatcher!</h1> 
                                <p><b>Customers are using Techmatcher to find new firms. </b> Your in-depth profile is key matching your service offerings with users' specific needs. Your firm can grow by doing what you do well.  Using Techmatcher analytics helps you to zoom in on specific market needs and help you stand out from the crowd.</p>
                            </div><!-- /intro-main -->
