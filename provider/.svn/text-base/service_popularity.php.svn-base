...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <script type="text/javascript">
    ...
    <body>
        ...
        <?php include_once "_change_pie_chart.php";?>
                                    ...
                                    <div id="main_div" class="white_header flt">
                                        <div class="white_bottom_mid_part">
                                            <div style="text-align:center;width:100%;">
                                                <?php $def_image_name =  "pie_popularsearches.png";
                                        ...
                                        <div class="white_header flt">
                                            <div class="white_bottom_mid_part">
                                                <div class="chartsettings">
                                                    <div class="left_part">
                                                        <form id="chart_data_form" method="POST" onsubmit="return change_pie_chart($(this));">
                                                        <div class="holder">
