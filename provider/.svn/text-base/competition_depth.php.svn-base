   ...
   <script type="text/javascript">
    ...
    <body>
        <?php include_once "../dao/search.php";?>
         <?php include_once "../partials/_change_competition_depth_chart.php";?>
        <!-- container -->
                        ...
                        <div class="page-content">
                            ...
                            <div class="page-container provider-profile">
                                <!-- page-container-top --><div class="page-container-top"></div><div class="page-container-inner clearfix">
                                    ...
                                    <h1>Service Providers Who Offer Services Like Mine</h1>
                                    ...
                                    <div id="main_div" class="white_header flt">
                                        <div class="white_bottom_mid_part">
                                            <div>
                                                <?php $def_image_name = "bar".$_SESSION['provider']['serviceprovider_id'].'_competition_depth.png';
                                                      $source ="../provider/charts/tempimages/";
                                                      $image_source = $source.$def_image_name;?>
                                                <img id="competition_depth_chart_img"  src="<?php echo $image_source;?>"/>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="white_header flt">
                                            <div class="white_bottom_mid_part">
                                                <div class="chartsettings">
                                                    <div class="left_part">
                                                        <form id="chart_data_form" method="POST" onsubmit="return change_competition_depth_chart($(this));">
                                                            <div class="holder">
