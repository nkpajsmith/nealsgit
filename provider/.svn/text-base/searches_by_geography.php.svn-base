...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <script type="text/javascript">
    ...
    <body>
        ...
        <?php include_once "../partials/_change_geo_chart.php";?>
                        ...
                        <div class="page-content">
                            ...
                            <div class="page-container provider-profile">
                                <!-- page-container-top --><div class="page-container-top"></div><div class="page-container-inner clearfix">
                                    ...
                                    <h1><a href="#">Number of Searches in My Geographic Area</a></h1>

                                    <div id="main_div" class="white_header flt">
                                        <div class="white_bottom_mid_part">
                                            <div id="image_div">
                                                <?php $def_image_name = "provider_".$_SESSION['provider']['serviceprovider_id']."_geo_default.png";
                                        ...
                                        <div class="white_header flt">
                                            <div class="white_bottom_mid_part">
                                                <div class="chartsettings">
                                                    <div class="left_part">
                                                        <form id="chart_data_form" method="POST" onsubmit="return change_geo_chart($(this));">
                                                            <div class="holder">
                                                                        ...
                                                                        <div class="field">
                                                                         ...
                                                                         <div class="field">
                                                                            ...
                                                                            <select id="geo_area" name="geo_area">
                                                                                <option value="zipcode">My Zip Code</option>
                                                                                <option value="city">My City</option>
                                                                                <option selected value="county">My County</option>
                                ...
                                <div class="page-container-bottom"></div></div><!-- /page-container -->
        ...
        <?php include_once '../includes/footer1.php';
              include_once '../popups/make_csv.php';
