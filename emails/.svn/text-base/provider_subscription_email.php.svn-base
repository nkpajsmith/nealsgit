<?php
$provider_email = $_SESSION['provider']['contactemailaddress'];
$provider_name  = $_SESSION['provider']['primaryname'];
$total          = $_POST["chargetotal"];

include_once '../dao/email_provider.php';
...
$eventDate = getStartEndDate($_SESSION['provider']['serviceprovider_id']);//@todo change it to provider if necessary
...
$mail->AddAddress($provider_email,$provider_name);// To address
