...
<form name="edit_address" id="adding_address" method="post" onsubmit="return edit_provider_address($(this));">
    <table width="90%" border="0" cellspacing="2" cellpadding="5" align="center">
        ...
        <tr>
            ...
            <td><input type="text" name="address_line1" id="address_line1" value="<?php echo $address1[0]['addressline1'];?>"/></td>
        </tr>
        <tr>
            <td align="right"><strong>Address line 2</strong></td>
            <td><input type="text" name="address_line2" id="address_line2" value="<?php echo $address1[0]['addressline2'];?>"/></td>
        </tr>
        <tr>
            <td align="right"><strong>City  <span style="color:#FF0000"/> *</strong></td>
            <td><input type="text" name="city" id="city" value="<?php echo $address1[0]['city'];?>" /></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="zip_code" id="zip_code" value="<?php echo $address1[0]['zipcode'];?>"/></td>
        </tr>
<?php
    ...
    <div id="div_register_errors_sp2" class="errordiv" style="margin:0px;"></div>
