...
<div class="scroll-pane skill-selector">    
        ...
        $i=0;
        while($list_count > $i) {?>
    <a id="level3_<?php echo $i; ?>" name="level3" href="javascript:void(0);" onclick="select_level3_value(this,<?php echo $list_record[$i]['serviceskill_id']; ?>);"><?php echo $list_record[$i]['serviceskillname']; ?></a>
            <?php $i++;
        }
        ?>
</div>
